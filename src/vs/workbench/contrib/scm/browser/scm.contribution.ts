...
// REMOVED: SCM view icon and container registration to hide from Activity Bar
...
// const viewContainer: any = null;

// REMOVED: SCM view welcome content registration
...
// REMOVED: SCM views registration
